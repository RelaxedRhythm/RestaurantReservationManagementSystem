            ...
            {reservations.map((reservation) => (
              <tr key={reservation._id} className="border-b">
                ...
                <td className=" p-3 flex gap-2">
                  <button
                    className="bg-blue-600 text-white p-3 flex flex-col sm:flex-row gap-2 rounded cursor-pointer"
                    onClick={() => {
                  ...
                  {reservation.status !== "cancelled" && (
                    <button
                      className="bg-red-600 text-white p-3 flex flex-col sm:flex-row gap-2 rounded cursor-pointer"
